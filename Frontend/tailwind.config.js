...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "custom-gradient":
          "linear-gradient(180deg, rgba(33, 33, 33, 0.53) 53%, #212121 100%)",
        "custom-gradient2":
          "linear-gradient(180deg, rgba(33, 33, 33, 0.53) 100%, #212121 53%)",
        "custom-gradient3":
          "linear-gradient(90deg, rgba(243, 67, 67, 0.58) 0%, #F64F77 100%)",
      },
      fontFamily: {
        vazir: "Vazir",
